...
function Start () {
       ...
       bottomWall.center = new Vector2 (0f, mainCam.ScreenToWorldPoint (new Vector3 (0f, -50f, 0f)).y + 0.5f);
       
       leftWall.size = new Vector2 (1f, mainCam.ScreenToWorldPoint (new Vector3 (0f,Screen.height * 2f, 0f)).y);
       leftWall.center = new Vector2 (mainCam.ScreenToWorldPoint (new Vector3 (0f, 0f, 0f)).x, 0f);
